      ...
      <div
        ...
        <div class="max-w-full overflow-x-auto">
          <table class="w-full table-auto">
            ...
            <tbody>
              <tr v-for="user in users" :key="user._id" class="border-b border-[#eee] dark:border-strokedark">
                <td class="py-5 px-4">
                ...
                <td class="py-5 px-4">
                  <div class="flex items-center space-x-3.5">
                    <button @click="editUser(user)" class="text-yellow-600 hover:text-yellow-900 mr-3">
