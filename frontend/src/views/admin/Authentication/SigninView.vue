...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-purple-50 to-gray-100"
  >
    <div
      class="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-xl"
    >
      <!-- Admin Title -->
