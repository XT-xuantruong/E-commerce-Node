...
const findcategory = (id) => {
  const category = categories.value.find((c) => c.category_id === id);
...
const openEditModal = (product) => {
  ...
  selectedProduct.value.thumbnail =
     selectedProduct.value.images[0].image_url;
  selectedProduct.value.images = selectedProduct.value.images.map(
...
const deleteProduct = async (product) => {
  if (confirm("Are you sure you want to delete this product?")) {
    try {
      ...
      await productServices.delete(product.product_id);
          ...
          <div class="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center space-x-4">
                  <div
                    v-for="(item, index) in selectedProduct.images"
                    :key="index"
                  ...
                  >
                    ...
                    <input
                      type="file"
                      @change="(event) => handleImagesUpload(index, event)"
                      accept="image/*"
                      class="absolute inset-0 opacity-0 cursor-pointer"
                    />
                ...
                <button
                  v-if="selectedProduct.images.length < MAX_IMAGES"
                  @click="addImageField"
